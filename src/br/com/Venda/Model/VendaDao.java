...
public class VendaDao {
    ...
    public void salvarVenda(vendaDTO dto) {
        ModuloConexao conexao = new ModuloConexao();
        String sql = "insert into carrinho (nome, descricao, qtdp, valor, forma_pg )value (?,?,?,?,?)";
        conexao.conector();
        try {
    ...
    public void salvarCarrinho(vendaDTO dto) {
        ModuloConexao conexao = new ModuloConexao();
        String sql = "insert into carrinho (nome, descricao, qtdp,valor, forma_pg) select nome, descricao, qtdp,valor, forma_pg from venda; ";
        conexao.conector();
        try {
            PreparedStatement pst = conexao.conn.prepareStatement(sql);
